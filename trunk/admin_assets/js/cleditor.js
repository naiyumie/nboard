	...
	*/
	...
	(function ($) {
	  ...
	  function refresh(editor) {
		...
		// Create a new iframe
		var $frame = editor.$frame = $('<iframe id="cleditor" frameborder="0" src="javascript:true;" />')
		  .hide()
		  .appendTo($main);
	  ...
	  function updateTextArea(editor, checkForChange) {
		...
		*/
		...
		(function ($) {
			...
			$.cleditor.buttons.table = {
				name: "table",
				image: "cleditor_table.png",
				title: "Insert Table",
				command: "inserthtml",
				popupName: "table",
				popupClass: "cleditorPrompt",
				popupContent:
					'<label>Cols:<br /><input type="text" value="2" style="width:40px"></label>&nbsp;&nbsp;' +
					'<label>Rows:<br /><input type="text" value="2" style="width:40px"></label>' +
			...
			function tableButtonClick(e, data) {
				...
				$(data.popup).children(":button")
					...
					.bind("click", function (e) {
						...
						var html;
						if (cols > 0 && rows > 0) {
							html = "<table summary='contents' cellpadding=2 cellspacing=2 border=1 style='border-collapse:collapse;border-color: #333;'>";
							for (y = 0; y < rows; y++) {
								html += "<tr>";
								for (x = 0; x < cols; x++)
									html += "<td style='border-color: #333;  padding: 5px 5px 5px 5px;'>" + '&nbsp' + "</td>";
								html += "</tr>";
							}
							html += "</table><br />";
						}
		...
		*/
		...
		(function($) {
		  ...
		  // Constants
		  var FOLDER = $.cleditor.imagesPath() + "cleditor_icons_",
			  STRIP = "",
			  EXT = ".png",
