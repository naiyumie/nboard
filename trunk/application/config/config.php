...
$config['permitted_uri_chars'] = 'a-z 0-9~%.:_\-?'; # 쿼리스트링 가능하게 수정.
...
|
*/
$config['encryption_key'] = 'naiyumie_board_@ASDF';
...
********************************/
	...
	$config['pagination']['num_tag_open'] ='<li class="num">';
	...
	$config['pagination']['first_tag_open'] = '<li class="first">';
	$config['pagination']['first_tag_close'] = '</li>';
	$config['pagination']['last_tag_open'] = '<li class="last">';
