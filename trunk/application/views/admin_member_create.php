			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<?php echo form_open(''.$context.'/create_proc/'.$this->uri->segment(4,0), array('class'=>'form-horizontal','id'=>'form')); ?>
							<fieldset>
								...
								<div class="control-group">
									<?php $field='user_pw';?>
									<label class="control-label" for="id_<?php echo $field?>">비밀번호</label>
									<div class="controls">
										<input name="<?php echo $field?>" id="id_<?php echo $field?>" value="<?php echo set_value($field); ?>" class="input-full" type="password"  >
										<?php echo form_error($field);?>
									</div>
								</div>
									...
									<div class="controls">
										...
										<select name="<?php echo $field?>" id="<?php echo $field?>">
											<?php foreach($select_array as $k=>$v):?>
												<option value="<?php echo $k;?>" <?php echo set_select($field, $k); ?>><?php echo $v?></option>
											<?php endforeach;?>
										</select>
										<?php echo form_error($field);?>
									</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="<?php echo $field?>" id="id_<?php echo $field?>" value="<?php echo set_value($field,1); ?>" class="input-mini" type="text"  >
										<?php echo form_error($field);?>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="<?php echo $field?>" class="input-small nDatePicker" id="<?php echo $field?>" value="<?php echo set_value($field, date('Y-m-d'));?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="<?php echo $field?>" class="input-small nTimePicker" id="<?php echo $field?>" value="<?php echo set_value($field, date('H:i:s')); ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="<?php echo $field?>" id="id_<?php echo $field?>" value="<?php echo set_value($field, 'test!'); ?>" class="input-mini" type="text"  >
										<?php echo form_error($field);?>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="<?php echo $field?>" id="id_<?php echo $field?>" value="<?php echo set_value($field, 0); ?>" class="input-mini" type="text"  >
										<?php echo form_error($field);?>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<label class="radio">
											<input type="radio" name="<?php echo $field?>" id="id_<?php echo $field;?>_1" value="Y" <?php echo set_radio($field,'Y'); ?>>
											탈퇴
										</label>
										<div style="clear:both"></div>
										<label class="radio">
											<input type="radio" name="<?php echo $field?>" id="id_<?php echo $field;?>_2" value="N" <?php echo set_radio($field,'N', TRUE); ?>>
											활동
										</label>
										<?php echo form_error($field);?>
									</div>
