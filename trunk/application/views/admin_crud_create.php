						...
						<?php echo form_open(''.$context.'/create_proc/'.$this->uri->segment(4,0), array('class'=>'form-horizontal','id'=>'form')); ?>
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<label class="checkbox inline">
											<input type="checkbox" name="<?php echo $field?>" id="id_<?php echo $field;?>_1" value="Y" <?php echo set_checkbox($field,'Y', ($this->input->post($field)=='Y')?TRUE:FALSE); ?>>
											체크 Y
										</label>
										<?php echo form_error($field);?>
									</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<label class="radio">
											<input type="radio" name="<?php echo $field?>" id="id_<?php echo $field;?>_1" value="type_a" <?php echo set_radio($field,'type_a', ($this->input->post($field)=='type_a')?TRUE:FALSE); ?>>
											type_a 타입A
										</label>
										<div style="clear:both"></div>
										<label class="radio">
											<input type="radio" name="<?php echo $field?>" id="id_<?php echo $field;?>_2" value="type_b" <?php echo set_radio($field,'type_b', ($this->input->post($field)=='type_b')?TRUE:FALSE); ?>>
											type_b 타입B
										</label>
										<?php echo form_error($field);?>
									</div>
